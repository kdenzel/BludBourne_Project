...
public class TownMap extends Map {
    ...
    private static String _townGuardWalking =
            "scripts/town_guard_walking.json";
    private static String _townBlacksmith =
            "scripts/town_blacksmith.json";
    private static String _townMage = "scripts/town_mage.json";
    private static String _townInnKeeper =
            "scripts/town_innkeeper.json";
    ...
    @Override
    public void updateMapEntities(MapManager mapMgr, Batch batch,
                                  float delta){
    ...
    private Entity initEntity(EntityConfig entityConfig, Vector2
            position){
